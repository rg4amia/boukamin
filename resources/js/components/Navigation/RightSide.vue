                                ...
                                <li class="notifications-not-read">
                                    <a href="">
                                                <span class="notification-avatar status-online">
                                                    <img src="/assets/images/user-avatar-small-03.jpg" alt="Boukamin">
                                                </span>
            ...
            <div class="header-notifications user-menu">
                ...
                <div class="header-notifications-dropdown">
                    ...
                    <ul class="user-menu-small-nav">
                        <li>
                            <router-link :to="{name: 'home'}"><i class="icon-material-outline-dashboard"></i> Dashboard</router-link>
                        </li>
                        <li>
                            <router-link :to="{name: 'home'}"><i class="icon-material-outline-settings"></i> Settings</router-link>
                        </li>
                        <li>
                            <router-link :to="{name: 'home'}"><i class="icon-material-outline-power-settings-new"></i> Logout</router-link>
                        </li>
                    </ul>
